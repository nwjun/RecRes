...
from .inference_batch import get_batch_information_general, pad_name, pad_ingredients, pad_steps, get_ingr_mask
from .inference_language_toolkit import TOKENIZER, END_INDEX, TECHNIQUES_LIST, recipe_spec_repr
...
def get_batch_generated_recipes(batch_generated, max_ingr=5, max_ingr_tok=20,
                                names_generated=None, ingr_map=None,
                                **tensor_kwargs):
    # Inputs
